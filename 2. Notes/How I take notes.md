[[Guide on how to use my vault]] **<- Click here to go back** 
...
## A bump piece of note 
My techniques changes a lot as I adapt my vault base on what I'm learning. This will be filled with details once I have settled with a stable flow of taking notes.
...
## **==ABANDONED Techniques below==**
Reason: I no longer use this technique because I have been constantly editing stuffs that I am leaning more towards progressive summarization now rather than the zettelkasten approach. 

But I'm sure you can get a thing or two from reading the stuffs below.
So I decided not to remove them.
